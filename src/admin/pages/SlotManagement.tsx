...
import {
  ...
  message, Spin, TimePicker, Collapse,
} from 'antd';
import {
  SearchOutlined, DeleteOutlined, EditOutlined, ReloadOutlined,
  PlusOutlined, CloseOutlined, InfoCircleOutlined, CopyOutlined,
...
const CAPACITY_TYPES = ['orders', 'items', 'weight_kg', 'volume_m3'];
...
const OVERRIDE_TYPES = ['close_slot', 'pull_cutoff', 'force_book', 'reduce_capacity', 'increase_capacity'];
const OVERRIDE_SCOPES = ['zone', 'store', 'slot', 'carrier', 'business_line'];
const HOLIDAY_ACTIONS = ['close', 'reduce', 'custom_hours'];
...
const REAL_SCHEDULES: Record<string, Record<string, ScheduleSlot[]>> = {
  '4660': {
    Monday: [{start:'14:00',end:'16:00',capacity:6,label:'Standard'},{start:'14:00',end:'17:00',capacity:8,label:'Standard'},{start:'15:00',end:'17:00',capacity:35,label:'Standard'},{start:'16:00',end:'18:00',capacity:38,label:'Standard'},{start:'17:00',end:'19:00',capacity:25,label:'Standard'},{start:'18:00',end:'20:00',capacity:26,label:'Standard'},{start:'19:00',end:'21:00',capacity:21,label:'Standard'},{start:'19:00',end:'22:00',capacity:5,label:'Standard'}],
    Tuesday: [{start:'07:00',end:'10:00',capacity:7,label:'Standard'},{start:'08:00',end:'10:00',capacity:5,label:'Standard'},{start:'08:00',end:'11:00',capacity:6,label:'Standard'},{start:'09:00',end:'11:00',capacity:2,label:'Standard'},{start:'10:00',end:'12:00',capacity:18,label:'Standard'},{start:'11:00',end:'13:00',capacity:28,label:'Standard'},{start:'12:00',end:'14:00',capacity:12,label:'Standard'},{start:'14:00',end:'17:00',capacity:8,label:'Standard'},{start:'15:00',end:'17:00',capacity:19,label:'Standard'},{start:'16:00',end:'18:00',capacity:42,label:'Standard'},{start:'17:00',end:'19:00',capacity:20,label:'Standard'},{start:'18:00',end:'20:00',capacity:41,label:'Standard'},{start:'19:00',end:'21:00',capacity:37,label:'Standard'},{start:'20:00',end:'22:00',capacity:20,label:'Standard'}],
    Wednesday: [{start:'07:00',end:'10:00',capacity:8,label:'Standard'},{start:'08:00',end:'10:00',capacity:8,label:'Standard'},{start:'08:00',end:'11:00',capacity:7,label:'Standard'},{start:'09:00',end:'11:00',capacity:10,label:'Standard'},{start:'10:00',end:'12:00',capacity:17,label:'Standard'},{start:'11:00',end:'13:00',capacity:24,label:'Standard'},{start:'12:00',end:'14:00',capacity:14,label:'Standard'},{start:'14:00',end:'17:00',capacity:8,label:'Standard'},{start:'15:00',end:'17:00',capacity:32,label:'Standard'},{start:'16:00',end:'18:00',capacity:33,label:'Standard'},{start:'17:00',end:'19:00',capacity:31,label:'Standard'},{start:'18:00',end:'20:00',capacity:41,label:'Standard'},{start:'19:00',end:'21:00',capacity:31,label:'Standard'},{start:'20:00',end:'22:00',capacity:8,label:'Standard'}],
    Thursday: [{start:'07:00',end:'10:00',capacity:7,label:'Standard'},{start:'08:00',end:'10:00',capacity:8,label:'Standard'},{start:'08:00',end:'11:00',capacity:8,label:'Standard'},{start:'09:00',end:'11:00',capacity:18,label:'Standard'},{start:'10:00',end:'12:00',capacity:16,label:'Standard'},{start:'11:00',end:'13:00',capacity:30,label:'Standard'},{start:'12:00',end:'14:00',capacity:15,label:'Standard'},{start:'14:00',end:'17:00',capacity:8,label:'Standard'},{start:'15:00',end:'17:00',capacity:20,label:'Standard'},{start:'16:00',end:'18:00',capacity:26,label:'Standard'},{start:'17:00',end:'19:00',capacity:29,label:'Standard'},{start:'18:00',end:'20:00',capacity:35,label:'Standard'},{start:'19:00',end:'21:00',capacity:32,label:'Standard'},{start:'19:00',end:'22:00',capacity:8,label:'Standard'},{start:'20:00',end:'22:00',capacity:11,label:'Standard'}],
    Friday: [{start:'07:00',end:'10:00',capacity:0,label:'Standard'},{start:'08:00',end:'10:00',capacity:0,label:'Standard'},{start:'10:00',end:'12:00',capacity:0,label:'Standard'},{start:'14:00',end:'17:00',capacity:0,label:'Standard'},{start:'17:00',end:'19:00',capacity:0,label:'Standard'},{start:'19:00',end:'21:00',capacity:0,label:'Standard'}],
    Saturday: [{start:'07:00',end:'10:00',capacity:7,label:'Standard'},{start:'08:00',end:'10:00',capacity:8,label:'Standard'},{start:'08:00',end:'11:00',capacity:8,label:'Standard'},{start:'09:00',end:'11:00',capacity:25,label:'Standard'},{start:'10:00',end:'12:00',capacity:29,label:'Standard'},{start:'11:00',end:'13:00',capacity:20,label:'Standard'},{start:'12:00',end:'14:00',capacity:10,label:'Standard'},{start:'14:00',end:'17:00',capacity:8,label:'Standard'},{start:'15:00',end:'17:00',capacity:23,label:'Standard'},{start:'16:00',end:'18:00',capacity:34,label:'Standard'},{start:'17:00',end:'19:00',capacity:40,label:'Standard'},{start:'18:00',end:'20:00',capacity:39,label:'Standard'},{start:'19:00',end:'21:00',capacity:37,label:'Standard'},{start:'20:00',end:'22:00',capacity:20,label:'Standard'}],
  },
  '4459': {
    Monday: [{start:'14:00',end:'17:00',capacity:8,label:'Standard'},{start:'15:00',end:'17:00',capacity:15,label:'Standard'},{start:'15:00',end:'18:00',capacity:8,label:'Standard'},{start:'16:00',end:'18:00',capacity:15,label:'Standard'},{start:'16:00',end:'19:00',capacity:6,label:'Standard'},{start:'17:00',end:'19:00',capacity:24,label:'Standard'},{start:'18:00',end:'20:00',capacity:25,label:'Standard'},{start:'19:00',end:'21:00',capacity:23,label:'Standard'},{start:'19:00',end:'22:00',capacity:6,label:'Standard'},{start:'20:00',end:'22:00',capacity:5,label:'Standard'}],
    Tuesday: [{start:'07:00',end:'10:00',capacity:6,label:'Standard'},{start:'08:00',end:'10:00',capacity:9,label:'Standard'},{start:'08:00',end:'11:00',capacity:14,label:'Standard'},{start:'09:00',end:'11:00',capacity:15,label:'Standard'},{start:'10:00',end:'12:00',capacity:15,label:'Standard'},{start:'11:00',end:'13:00',capacity:21,label:'Standard'},{start:'12:00',end:'14:00',capacity:21,label:'Standard'},{start:'13:00',end:'15:00',capacity:6,label:'Standard'},{start:'14:00',end:'17:00',capacity:7,label:'Standard'},{start:'15:00',end:'17:00',capacity:10,label:'Standard'},{start:'16:00',end:'18:00',capacity:15,label:'Standard'},{start:'16:00',end:'19:00',capacity:12,label:'Standard'},{start:'17:00',end:'19:00',capacity:22,label:'Standard'},{start:'18:00',end:'20:00',capacity:21,label:'Standard'},{start:'19:00',end:'21:00',capacity:21,label:'Standard'},{start:'19:00',end:'22:00',capacity:12,label:'Standard'},{start:'20:00',end:'22:00',capacity:6,label:'Standard'}],
    Wednesday: [{start:'07:00',end:'10:00',capacity:6,label:'Standard'},{start:'08:00',end:'10:00',capacity:9,label:'Standard'},{start:'08:00',end:'11:00',capacity:13,label:'Standard'},{start:'09:00',end:'11:00',capacity:15,label:'Standard'},{start:'10:00',end:'12:00',capacity:15,label:'Standard'},{start:'11:00',end:'13:00',capacity:24,label:'Standard'},{start:'12:00',end:'14:00',capacity:21,label:'Standard'},{start:'13:00',end:'15:00',capacity:6,label:'Standard'},{start:'14:00',end:'17:00',capacity:7,label:'Standard'},{start:'15:00',end:'17:00',capacity:10,label:'Standard'},{start:'16:00',end:'18:00',capacity:15,label:'Standard'},{start:'17:00',end:'19:00',capacity:24,label:'Standard'},{start:'18:00',end:'20:00',capacity:27,label:'Standard'},{start:'19:00',end:'21:00',capacity:26,label:'Standard'},{start:'19:00',end:'22:00',capacity:11,label:'Standard'},{start:'20:00',end:'22:00',capacity:11,label:'Standard'}],
    Thursday: [{start:'07:00',end:'10:00',capacity:8,label:'Standard'},{start:'08:00',end:'10:00',capacity:8,label:'Standard'},{start:'08:00',end:'11:00',capacity:13,label:'Standard'},{start:'09:00',end:'11:00',capacity:15,label:'Standard'},{start:'10:00',end:'12:00',capacity:15,label:'Standard'},{start:'11:00',end:'13:00',capacity:21,label:'Standard'},{start:'12:00',end:'14:00',capacity:21,label:'Standard'},{start:'13:00',end:'15:00',capacity:6,label:'Standard'},{start:'14:00',end:'17:00',capacity:8,label:'Standard'},{start:'15:00',end:'17:00',capacity:15,label:'Standard'},{start:'16:00',end:'18:00',capacity:15,label:'Standard'},{start:'16:00',end:'19:00',capacity:12,label:'Standard'},{start:'17:00',end:'19:00',capacity:23,label:'Standard'},{start:'18:00',end:'20:00',capacity:21,label:'Standard'},{start:'19:00',end:'21:00',capacity:21,label:'Standard'},{start:'19:00',end:'22:00',capacity:14,label:'Standard'},{start:'20:00',end:'22:00',capacity:6,label:'Standard'}],
    Friday: [{start:'07:00',end:'10:00',capacity:0,label:'Standard'},{start:'08:00',end:'10:00',capacity:0,label:'Standard'},{start:'10:00',end:'12:00',capacity:0,label:'Standard'},{start:'14:00',end:'17:00',capacity:0,label:'Standard'},{start:'17:00',end:'19:00',capacity:0,label:'Standard'},{start:'19:00',end:'21:00',capacity:0,label:'Standard'}],
    Saturday: [{start:'07:00',end:'10:00',capacity:8,label:'Standard'},{start:'08:00',end:'10:00',capacity:9,label:'Standard'},{start:'08:00',end:'11:00',capacity:22,label:'Standard'},{start:'09:00',end:'11:00',capacity:15,label:'Standard'},{start:'09:00',end:'12:00',capacity:8,label:'Standard'},{start:'10:00',end:'12:00',capacity:15,label:'Standard'},{start:'11:00',end:'13:00',capacity:23,label:'Standard'},{start:'12:00',end:'14:00',capacity:12,label:'Standard'},{start:'12:00',end:'15:00',capacity:13,label:'Standard'},{start:'14:00',end:'17:00',capacity:8,label:'Standard'},{start:'15:00',end:'17:00',capacity:15,label:'Standard'},{start:'16:00',end:'18:00',capacity:15,label:'Standard'},{start:'17:00',end:'19:00',capacity:23,label:'Standard'},{start:'18:00',end:'20:00',capacity:21,label:'Standard'},{start:'19:00',end:'21:00',capacity:22,label:'Standard'},{start:'19:00',end:'22:00',capacity:5,label:'Standard'},{start:'20:00',end:'22:00',capacity:6,label:'Standard'}],
  },
  '4661': {
    Monday: [{start:'14:00',end:'17:00',capacity:12,label:'Standard'},{start:'15:00',end:'17:00',capacity:5,label:'Standard'},{start:'15:00',end:'18:00',capacity:7,label:'Standard'},{start:'16:00',end:'18:00',capacity:17,label:'Standard'},{start:'17:00',end:'19:00',capacity:17,label:'Standard'},{start:'18:00',end:'20:00',capacity:17,label:'Standard'},{start:'18:00',end:'21:00',capacity:7,label:'Standard'},{start:'19:00',end:'21:00',capacity:12,label:'Standard'},{start:'19:00',end:'22:00',capacity:7,label:'Standard'}],
    Tuesday: [{start:'08:00',end:'10:00',capacity:7,label:'Standard'},{start:'08:00',end:'11:00',capacity:5,label:'Standard'},{start:'09:00',end:'11:00',capacity:7,label:'Standard'},{start:'09:00',end:'12:00',capacity:7,label:'Standard'},{start:'10:00',end:'12:00',capacity:14,label:'Standard'},{start:'11:00',end:'13:00',capacity:21,label:'Standard'},{start:'11:00',end:'14:00',capacity:7,label:'Standard'},{start:'12:00',end:'14:00',capacity:12,label:'Standard'},{start:'14:00',end:'17:00',capacity:6,label:'Standard'},{start:'15:00',end:'17:00',capacity:7,label:'Standard'},{start:'15:00',end:'18:00',capacity:20,label:'Standard'},{start:'16:00',end:'18:00',capacity:14,label:'Standard'},{start:'17:00',end:'19:00',capacity:18,label:'Standard'},{start:'18:00',end:'20:00',capacity:19,label:'Standard'},{start:'18:00',end:'21:00',capacity:10,label:'Standard'},{start:'19:00',end:'21:00',capacity:9,label:'Standard'},{start:'19:00',end:'22:00',capacity:10,label:'Standard'}],
    Wednesday: [{start:'08:00',end:'10:00',capacity:7,label:'Standard'},{start:'08:00',end:'11:00',capacity:7,label:'Standard'},{start:'09:00',end:'11:00',capacity:7,label:'Standard'},{start:'09:00',end:'12:00',capacity:7,label:'Standard'},{start:'10:00',end:'12:00',capacity:14,label:'Standard'},{start:'11:00',end:'13:00',capacity:21,label:'Standard'},{start:'11:00',end:'14:00',capacity:10,label:'Standard'},{start:'12:00',end:'14:00',capacity:14,label:'Standard'},{start:'14:00',end:'17:00',capacity:4,label:'Standard'},{start:'15:00',end:'17:00',capacity:5,label:'Standard'},{start:'15:00',end:'18:00',capacity:6,label:'Standard'},{start:'16:00',end:'18:00',capacity:10,label:'Standard'},{start:'17:00',end:'19:00',capacity:15,label:'Standard'},{start:'18:00',end:'20:00',capacity:15,label:'Standard'},{start:'18:00',end:'21:00',capacity:5,label:'Standard'},{start:'19:00',end:'21:00',capacity:9,label:'Standard'},{start:'19:00',end:'22:00',capacity:5,label:'Standard'}],
    Thursday: [{start:'08:00',end:'10:00',capacity:7,label:'Standard'},{start:'08:00',end:'11:00',capacity:7,label:'Standard'},{start:'09:00',end:'11:00',capacity:7,label:'Standard'},{start:'09:00',end:'12:00',capacity:7,label:'Standard'},{start:'10:00',end:'12:00',capacity:14,label:'Standard'},{start:'11:00',end:'13:00',capacity:21,label:'Standard'},{start:'11:00',end:'14:00',capacity:7,label:'Standard'},{start:'12:00',end:'14:00',capacity:14,label:'Standard'},{start:'14:00',end:'17:00',capacity:4,label:'Standard'},{start:'15:00',end:'17:00',capacity:5,label:'Standard'},{start:'15:00',end:'18:00',capacity:7,label:'Standard'},{start:'16:00',end:'18:00',capacity:18,label:'Standard'},{start:'17:00',end:'19:00',capacity:20,label:'Standard'},{start:'18:00',end:'20:00',capacity:16,label:'Standard'},{start:'18:00',end:'21:00',capacity:6,label:'Standard'},{start:'19:00',end:'21:00',capacity:10,label:'Standard'},{start:'19:00',end:'22:00',capacity:6,label:'Standard'}],
    Friday: [{start:'07:00',end:'10:00',capacity:0,label:'Standard'},{start:'08:00',end:'10:00',capacity:0,label:'Standard'},{start:'10:00',end:'12:00',capacity:0,label:'Standard'},{start:'14:00',end:'17:00',capacity:0,label:'Standard'},{start:'17:00',end:'19:00',capacity:0,label:'Standard'},{start:'18:00',end:'21:00',capacity:0,label:'Standard'},{start:'19:00',end:'22:00',capacity:0,label:'Standard'}],
    Saturday: [{start:'08:00',end:'10:00',capacity:7,label:'Standard'},{start:'08:00',end:'11:00',capacity:7,label:'Standard'},{start:'09:00',end:'11:00',capacity:7,label:'Standard'},{start:'09:00',end:'12:00',capacity:7,label:'Standard'},{start:'10:00',end:'12:00',capacity:14,label:'Standard'},{start:'11:00',end:'13:00',capacity:21,label:'Standard'},{start:'11:00',end:'14:00',capacity:7,label:'Standard'},{start:'12:00',end:'14:00',capacity:14,label:'Standard'},{start:'14:00',end:'17:00',capacity:5,label:'Standard'},{start:'15:00',end:'17:00',capacity:4,label:'Standard'},{start:'15:00',end:'18:00',capacity:5,label:'Standard'},{start:'16:00',end:'18:00',capacity:9,label:'Standard'},{start:'17:00',end:'19:00',capacity:18,label:'Standard'},{start:'18:00',end:'20:00',capacity:17,label:'Standard'},{start:'18:00',end:'21:00',capacity:5,label:'Standard'},{start:'19:00',end:'21:00',capacity:9,label:'Standard'},{start:'19:00',end:'22:00',capacity:5,label:'Standard'}],
  },
};
...
export default function SlotManagement() {
  ...
  const [selectedRows, setSelectedRows] = useState<SlotConfigRecord[]>([]);
